...
public class Server extends ServerUtils implements Runnable {
    ...
    private void startServer() throws IOException {
        ...
        // print info
        System.out.print("\nThis server is running on the local host machine listening\n" +
        "for bluetooth client device that will connect using the same UUID.\n" +
        "In order for the devices to connect they must first be paired to each other.\n" +
        "It is best to pair from the remote device to the host machine.\n\n");
